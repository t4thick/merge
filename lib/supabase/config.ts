...
export function formatCatalogError(error: { message?: string } | null, configured: boolean): string {
  if (!configured) {
    return 'Our online catalog is temporarily unavailable while we finish setup. Please call (614) 377-8297 or visit us at 1668 E Dublin Granville Rd, Columbus, OH.'
  }
