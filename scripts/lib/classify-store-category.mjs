...
const NAME_RULES = [
  ...
  {
    cat: 'Lace',
    words: ['lace fabric', 'french lace', 'guipure', 'voile lace', 'cord lace'],
    weight: 12,
  },
  {
    cat: 'Ready-to-wear',
  ...
  {
    cat: 'Non food',
    words: ['plastic drum', 'pot ', ' pan', 'utensil', 'plate', 'cup', 'florida water'],
    weight: 9,
  },
  {
    cat: 'Motherland',
    words: ['kente', 'chewing stick', 'kaawe', 'shile', 'authentic shile'],
    weight: 8,
  },
]
